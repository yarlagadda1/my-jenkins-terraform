...
Launch EC2 instance with ubuntu ami, with http and custom tcp with 8080 from anywhere
Run the below script with instance connect
...
set dummy user name and password

Manage Jenkins

plugin------> search for aws, ec2,codebuild,coddepipeline
